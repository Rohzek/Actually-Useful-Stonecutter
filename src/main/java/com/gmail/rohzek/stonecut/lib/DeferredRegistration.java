...
{
	public static final DeferredRegister<IRecipeSerializer<?>> RECIPE_SERIALIZERS = new DeferredRegister<IRecipeSerializer<?>>(ForgeRegistries.RECIPE_SERIALIZERS, Reference.MODID);
